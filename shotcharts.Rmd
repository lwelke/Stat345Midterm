...
p1 <- plot_court(court_themes$light) + 
  geom_point(data = bucks14, aes(x = x, y = y, color = isShotMade, fill = isShotMade),alpha = .3, size = 1.5, shape = 21, stroke = .5) +  
...
#Creating the Chart
p1 <- plot_court(court_themes$light) +
  geom_point(data = bucks17, aes(x = x, y = y, color = isShotMade, fill = isShotMade),alpha = .3, size = 1.5, shape = 21, stroke = .5) +  
  scale_color_manual(values = c("#009429","#F7A500"), aesthetics = "color", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_fill_manual(values = c("#009429","#F7A500"), aesthetics = "fill", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
  scale_y_continuous(limits = c(0, 40)) +
...
#Creating the Chart
p1 <- plot_court(court_themes$light) +
  geom_point(data = bucks19, aes(x = x, y = y, color = isShotMade, fill = isShotMade),alpha = .3, size = 1.5, shape = 21, stroke = .5) +  
  scale_color_manual(values = c("#009429","#F7A500"), aesthetics = "color", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_fill_manual(values = c("#009429","#F7A500"), aesthetics = "fill", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
  scale_y_continuous(limits = c(0, 40)) +
...
#Creating the chart
p1 <- plot_court(court_themes$light) +
  geom_point(data = bucks21, aes(x = x, y = y, color = isShotMade, fill = isShotMade),alpha = 0.3, size = 1.5, shape = 21, stroke = .5) +  
  scale_color_manual(values = c("#009429","#F7A500"), aesthetics = "color", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_fill_manual(values = c("#009429","#F7A500"), aesthetics = "fill", breaks=c("TRUE", "FALSE"), labels=c("Made", "Missed")) +
  scale_x_continuous(limits = c(-27.5, 27.5)) +
  scale_y_continuous(limits = c(0, 40)) +
